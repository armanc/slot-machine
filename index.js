...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var response, row, index, elements;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                elements = board.flatMap(function (row) {
                    return row.map(function (symbol) { return symbol.value; });
                });
                lines.forEach(function (line) {
                    ...
                    if (lineValues.every(function (value, i, values) { return value === values[0]; })) {
                        // add some cash
                        var prize = lineValues[0].price * (lineValues.length + 1);
                        playerCash += prize;
